...
function Sidebar({ routes, menuToggle }) {
    ...
    >
      <div className="nk-sidebar-element nk-sidebar-head">
        <div className="nk-sidebar-brand">
          ...
          >
            <div className="fs-2 fw-bold text-white logo-img">Admin</div>
            {/* <ImageElement
              className="logo-img"
              previewSource="/assets/images/admin/logo-light.svg"
              alt="logo"
            /> */}
            <div className="fs-2 text-white fw-bold logo-small logo-img logo-img-small">
              A
            </div>
          </Link>
        </div>
